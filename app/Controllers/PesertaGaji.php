...
class PesertaGaji extends BaseController
{
   ...
   /**
    ...
    public function create()
    {
        ...
        $result = PesertaGajiModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = PesertaGajiModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (PesertaGajiModel::findById($id) === FALSE){
        ...
        $result = PesertaGajiModel::softDelete($id, $this->user);
