...
class BatchPembayaran extends BaseController
{

    public $modulName = 'BatchPembayaran';
   ...
   /**
    ...
    public function index()
    {
        ...
        $data = BatchPembayaranModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = BatchPembayaranModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = BatchPembayaranModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = BatchPembayaranModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (BatchPembayaranModel::findById($id) === FALSE){
        ...
        $result = BatchPembayaranModel::softDelete($id, $this->user);
