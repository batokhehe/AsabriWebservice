...
class Produk extends BaseController
{
   ...
   /**
    ...
    public function create()
    {
        ...
        $result = ProdukModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = ProdukModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (ProdukModel::findById($id) === FALSE){
        ...
        $result = ProdukModel::softDelete($id, $this->user);
