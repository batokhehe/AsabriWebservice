...
class PendelegasianWewenang extends BaseController
{

    public $modulName = 'Pendelegasian Wewenang';
    ...
    public function index()
    {
        ...
        $data = PendelegasianWewenangModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = PendelegasianWewenangModel::findById($id);
