...
use App\Models\OtentikasiPensiunModel;

class OtentikasiPensiun extends BaseController
{

    public $modulName = 'Otentikasi Pensiun';
   ...
   /**
    ...
    public function index()
    {
        ...
        $data = OtentikasiPensiunModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = OtentikasiPensiunModel::findById($id);
