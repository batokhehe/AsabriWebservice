...
use App\Models\KtpaGeneratorModel;

class KtpaGenerator extends BaseController
{

    public $modulName = 'Ktpa Generator';
   ...
   /**
    ...
    public function index()
    {
        ...
        $data = KtpaGeneratorModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = KtpaGeneratorModel::findById($id);
