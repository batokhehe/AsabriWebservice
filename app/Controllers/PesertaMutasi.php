...
class PesertaMutasi extends BaseController
{

    public $modulName = 'PesertaMutasi';
   ...
   /**
    ...
    public function index()
    {
        ...
        $data = PesertaMutasiModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = PesertaMutasiModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = PesertaMutasiModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = PesertaMutasiModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (PesertaMutasiModel::findById($id) === FALSE){
        ...
        $result = PesertaMutasiModel::softDelete($id, $this->user);
