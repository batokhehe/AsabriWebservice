...
use App\Models\PembayaranHutangPesertaModel;

class PembayaranHutangPeserta extends BaseController
{

    public $modulName = 'Pembayaran Hutang Peserta';
    ...
    public function index()
    {
        ...
        $data = PembayaranHutangPesertaModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = PembayaranHutangPesertaModel::findById($id);
