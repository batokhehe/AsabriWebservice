...
class TipeDokumen extends BaseController
{
    public $modulName = 'Tipe Dokumen';
    ...
    public function show($id = null){
        ...
        $data = TipeDokumenModel::findById($id);
        if (!$data){
    ...
    public function create(){
        ...
        $rules = [
            ...
            'tipe_dokumen_unique_code' => 'required|is_unique[ref_tipe_dokumen.tipe_dokumen_unique_code]',
            'deskripsi' => 'required',
            'status' => 'required'
        ];
        ...
        $jenisKlaim = TipeDokumenModel::createNew($this->request, $this->user);
        if (!$jenisKlaim){
            return $this->respondCreated([
                    'status' => 500,
                    'error' => true,
    ...
    public function update($id = null){
        ...
        // check availability
        if (!TipeDokumenModel::findById($id)){
            return $this->respondCreated([
                'status' => 400,
                'error' => true,
        ...
        // do update
        TipeDokumenModel::updateData($id, $this->request, $this->user);
    ...
    public function delete($id = null){
        ...
        TipeDokumenModel::softDelete($id, $this->user);
