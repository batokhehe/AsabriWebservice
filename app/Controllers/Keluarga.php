...
class Keluarga extends BaseController
{
   ...
   /**
    ...
    public function show($id = null)
    {
        ...
        $result = KeluargaModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = KeluargaModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = KeluargaModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (KeluargaModel::findById($id) === FALSE){
        ...
        $result = KeluargaModel::softDelete($id, $this->user);
