...
class Faskes extends BaseController
{
   ...
   /**
    ...
    public function show($id = null)
    {
        ...
        $result = FaskesModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = FaskesModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = FaskesModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (FaskesModel::findById($id) === FALSE){
        ...
        $result = FaskesModel::softDelete($id, $this->user);
