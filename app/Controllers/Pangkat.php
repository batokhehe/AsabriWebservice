...
class Pangkat extends BaseController
{
   ...
   /**
    ...
    public function create()
    {
        ...
        $data = [
            'pangkat_unique_code' =>  $this->request->getVar('pangkat_unique_code'), 
            'nama_pangkat' =>  $this->request->getVar('nama_pangkat'), 
            'kode_pangkat' =>  $this->request->getVar('kode_pangkat'), 
            'keterangan' =>  $this->request->getVar('keterangan'), 
            'status' =>  $this->request->getVar('status'), 
            'kelompok_pangkat_id' =>  $this->request->getVar('kelompok_pangkat_id'), 
            'unit_organisasi_id' =>  $this->request->getVar('unit_organisasi_id'), 
