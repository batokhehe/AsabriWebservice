...
class CacatGolongan extends BaseController
{
   ...
   /**
    ...
    public function create()
    {
        ...
        $data = [
            'cacat_golongan_unique_code' =>  $this->request->getVar('cacat_golongan_unique_code'), 
            'nama_cacat_golongan' =>  $this->request->getVar('nama_cacat_golongan'), 
            'kode_cacat_golongan' =>  $this->request->getVar('kode_cacat_golongan'), 
