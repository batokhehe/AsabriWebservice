...
class Manfaat extends BaseController
{
   ...
   /**
    ...
    public function show($id = null)
    {
        ...
        $result = ManfaatModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = ManfaatModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = ManfaatModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (ManfaatModel::findById($id) === FALSE){
        ...
        $result = ManfaatModel::softDelete($id, $this->user);
