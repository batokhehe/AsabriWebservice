...
class PesertaCacat extends BaseController
{

    public $modulName = 'PesertaCacat';
   ...
   /**
    ...
    public function show($id = null)
    {
        ...
        $result = PesertaCacatModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = PesertaCacatModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = PesertaCacatModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (PesertaCacatModel::findById($id) === FALSE){
        ...
        $result = PesertaCacatModel::softDelete($id, $this->user);
