...
use App\Models\PesertaIuranModel;

class PesertaIuran extends BaseController
{

    public $modulName = 'Peserta Iuran';
    ...
    public function show($id = null)
    {
        ...
        $result = PesertaIuranModel::findById($id);
