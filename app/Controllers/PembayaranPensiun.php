...
class PembayaranPensiun extends BaseController
{

    public $modulName = 'PembayaranPensiun';
    ...
    public function index()
    {
        ...
        $data = PembayaranPensiunModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = PembayaranPensiunModel::findById($id);
