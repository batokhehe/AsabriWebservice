...
class PesertaProduk extends BaseController
{

    public $modulName = 'PesertaProduk';
   ...
   /**
    ...
    public function index()
    {
        ...
        $data = PesertaProdukModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = PesertaProdukModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = PesertaProdukModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = PesertaProdukModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (PesertaProdukModel::findById($id) === FALSE){
        ...
        $result = PesertaProdukModel::softDelete($id, $this->user);
