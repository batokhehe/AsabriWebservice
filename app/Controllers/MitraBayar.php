...
class MitraBayar extends BaseController
{

    public $modulName = 'MitraBayar';
   ...
   /**
    ...
    public function show($id = null)
    {
        ...
        $result = MitraBayarModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = MitraBayarModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = MitraBayarModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (MitraBayarModel::findById($id) === FALSE){
        ...
        $result = MitraBayarModel::softDelete($id, $this->user);
