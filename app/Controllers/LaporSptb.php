...
use App\Models\LaporSptbModel;

class LaporSptb extends BaseController
{

    public $modulName = 'LaporSptb';
   ...
   /**
    ...
    public function show($id = null)
    {
        ...
        $result = LaporSptbModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = LaporSptbModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = LaporSptbModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (LaporSptbModel::findById($id) === FALSE){
        ...
        $result = LaporSptbModel::softDelete($id, $this->user);
