...
class JenisProduk extends BaseController
{
    ...
    public function show($id = null){
        ...
        $data = JenisProdukModel::findById($id);
        if (!$data){
    ...
    public function create(){
        ...
        $jenisKlaim = JenisProdukModel::createNew($this->request, $this->user);
        if (!$jenisKlaim){
            return $this->respondCreated([
                    'status' => 500,
                    'error' => true,
    ...
    public function update($id = null){
        ...
        // check availability
        if (!JenisProdukModel::findById($id)){
            return $this->respondCreated([
                'status' => 400,
                'error' => true,
        ...
        // do update
        JenisProdukModel::updateData($id, $this->request, $this->user);
    ...
    public function delete($id = null){
        ...
        JenisProdukModel::softDelete($id, $this->user);
