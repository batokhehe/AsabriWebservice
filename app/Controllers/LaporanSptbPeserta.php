...
use App\Models\LaporanSptbPesertaModel;

class LaporanSptbPeserta extends BaseController
{

    public $modulName = 'Laporan Sptb Peserta';
   ...
   /**
    ...
    public function index()
    {
        ...
        $data = LaporanSptbPesertaModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = LaporanSptbPesertaModel::findById($id);
