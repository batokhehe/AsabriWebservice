...
class PesertaHutang extends BaseController
{

    public $modulName = 'PesertaHutang';
   ...
   /**
    ...
    public function index()
    {
        ...
        $data = PesertaHutangModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = PesertaHutangModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = PesertaHutangModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = PesertaHutangModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (PesertaHutangModel::findById($id) === FALSE){
        ...
        $result = PesertaHutangModel::softDelete($id, $this->user);
