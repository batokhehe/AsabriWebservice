...
class Klaim extends BaseController
{
   ...
   /**
    ...
    public function create()
    {
        ...
        $result = KlaimModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = KlaimModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (KlaimModel::findById($id) === FALSE){
        ...
        $result = KlaimModel::softDelete($id, $this->user);
