...
use App\Models\ProdukPremiModel;

class ProdukPremi extends BaseController
{

    public $modulName = 'Produk Premi';
   ...
   /**
    ...
    public function show($id = null)
    {
        ...
        $result = ProdukPremiModel::findById($id);
