...
use App\Models\PesertaBintangJasaModel;

class PesertaBintangJasa extends BaseController
{

    public $modulName = 'Peserta Bintang Jasa';
   ...
   /**
    ...
    public function index()
    {
        ...
        $data = PesertaBintangJasaModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = PesertaBintangJasaModel::findById($id);
