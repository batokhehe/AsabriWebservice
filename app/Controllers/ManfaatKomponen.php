...
class ManfaatKomponen extends BaseController
{

    public $modulName = 'ManfaatKomponen';
   ...
   /**
    ...
    public function index()
    {
        ...
        $data = ManfaatKomponenModel::getAll();
    ...
    public function show($id = null)
    {
        ...
        $result = ManfaatKomponenModel::findById($id);
    ...
    public function create()
    {
        ...
        $result = ManfaatKomponenModel::createNew($this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function update($id = null)
    {
        ...
        $result = ManfaatKomponenModel::updateData($id, $this->request, $this->user);
        if ($result === FALSE) {
            $response = [
                'status' => 500,
                'error' => true,
    ...
    public function delete($id = null)
    {
        if (empty($this->user)) {
         ...
         // check availability
        if (ManfaatKomponenModel::findById($id) === FALSE){
        ...
        $result = ManfaatKomponenModel::softDelete($id, $this->user);
