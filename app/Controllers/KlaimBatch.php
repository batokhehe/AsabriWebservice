...
use App\Models\KlaimBatchModel;

class KlaimBatch extends BaseController
{

    public $modulName = 'Klaim Batch';
    ...
    public function show($id = null)
    {
        ...
        $result = KlaimBatchModel::findById($id);
