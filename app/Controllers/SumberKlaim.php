...
use App\Models\SumberKlaimModel;

class SumberKlaim extends BaseController
{

    public $modulName = 'Sumber Klaim';
    ...
    public function show($id = null)
    {
        ...
        $result = SumberKlaimModel::findById($id);
