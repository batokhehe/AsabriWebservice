...
class ProdukModel extends Model
{
    ...
    protected $uniqueCode       = 'produk_unique_code';
    ...
    protected $validationRules = [
        ...
        'deskripsi'                        => 'required',
        'jenis_produk_id'                  => 'required|is_jenis_produk_exists[jenis_produk_id]',
    ...
    {
        $jenisProduk = JenisProdukModel::findById($request->getVar('jenis_produk_id'));
        ...
        return $model->insert([
            ...
            'jenis_produk_unique_code'         => $jenisProduk['jenis_produk_unique_code'],
            'nama_jenis_produk'                => $jenisProduk['nama_jenis_produk'],
