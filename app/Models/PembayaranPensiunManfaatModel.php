...
class PembayaranPensiunManfaatModel extends Model
{
    ...
    protected $uniqueCode       = 'pembayaran_pensiun_manfaat_unique_code';
    ...
    protected $validationRules = [
        ...
        'pembayaran_pensiun_id'                  => 'required|is_pembayaran_pensiun_exists[pembayaran_pensiun_id]',
        'manfaat_komponen_id'                    => 'required|is_manfaat_komponen_exists[manfaat_komponen_id]',
    ...
    {
        $pembayaranPensiun = PembayaranPensiunModel::findById($request->getVar('pembayaran_pensiun_id'));
        $manfaatKomponen   = ManfaatKomponenModel::findById($request->getVar('manfaat_komponen_id'));
        ...
        return $model->insert([
            ...
            'pembayaran_pensiun_unique_code'         => $pembayaranPensiun['pembayaran_pensiun_unique_code'],
            'manfaat_komponen_id'                    => $request->getVar('manfaat_komponen_id'),
            'manfaat_komponen_unique_code'           => $manfaatKomponen['manfaat_komponen_unique_code'],
            'nama_manfaat_komponen'                  => $manfaatKomponen['nama_manfaat_komponen'],
            'kode_manfaat_komponen'                  => $manfaatKomponen['kode_manfaat_komponen'],
